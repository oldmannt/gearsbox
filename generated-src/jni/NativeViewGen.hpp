...
private:
    ...
    public:
        ...
        std::shared_ptr<::gearsbox::ViewGen> addSubView(const std::string & id) override;
    ...
    const jmethodID method_addSubView { ::djinni::jniGetMethodID(clazz.get(), "addSubView", "(Ljava/lang/String;)Ldyno/fun/gearsbox/ViewGen;") };
