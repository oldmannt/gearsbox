...
private:
    ...
    public:
        ...
        bool initialize(const std::string & filepath, int32_t fps, int32_t bitrate, ::gearsbox::VideoOrientation ori, int32_t width, int32_t height, const std::shared_ptr<::gearsbox::VideoFrameGen> & frame) override;
    ...
    const jmethodID method_initialize { ::djinni::jniGetMethodID(clazz.get(), "initialize", "(Ljava/lang/String;IILdyno/fun/gearsbox/VideoOrientation;IILdyno/fun/gearsbox/VideoFrameGen;)Z") };
    const jmethodID method_encodeFrame { ::djinni::jniGetMethodID(clazz.get(), "encodeFrame", "(Ldyno/fun/gearsbox/VideoFrameGen;)V") };
    const jmethodID method_setFps { ::djinni::jniGetMethodID(clazz.get(), "setFps", "(I)V") };
