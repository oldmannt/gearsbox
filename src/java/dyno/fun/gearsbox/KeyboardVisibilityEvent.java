...
public class KeyboardVisibilityEvent {
    ...
    public static void setEventListener(final Activity activity,
        ...
        final View activityRoot = utils.getActivityRoot(activity);
        ...
        activityRoot.getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    private final int visibleThreshold = Math.round(
                            utils.convertDpToPx(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
    ...
    public static boolean isKeyboardVisible(Activity activity) {
        ...
        View activityRoot = utils.getActivityRoot(activity);
        int visibleThreshold = Math
                .round(utils.convertDpToPx(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
